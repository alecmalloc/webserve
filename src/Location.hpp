...
//getter functions
 ...
 const std::map< std::string, bool >    Location::getAllowedMethods( void ) const{
...
void	Location:: setAllowedMethod( std::string method, bool status ){
	_allowedMethods[ method ] = status;
}
